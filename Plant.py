...
disease_data = {
    ...
    "Potato Late Blight": {
        ...
        "bn": {
            ...
            "medicine": "ক্লোरोথ্যালোনিল বা ম্যানকোজেব ধারণকারী ছত্রাকনাশক স্প্রে ব্যবহার করুন। গাছের মধ্যে সঠিক দূরত্ব নিশ্চিত করুন এবং সরাসরি পাতায় জল দেওয়া এড়িয়ে চলুন।"
        },
        "mr": {
...
if st.session_state.history:
    # Use a DataFrame to display the history table correctly
